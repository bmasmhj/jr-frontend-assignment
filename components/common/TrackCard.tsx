...
const Artist: React.FC<Props> = ({ artist }) => {
    return (    
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-transparent text-gray-700 shadow-none text-center">
            <Image width={500} height={500} src="/material-tailwind-kit-react/img/team-1.jpg" alt="Ryan Tompson" className="inline-block relative object-cover object-center rounded-2xl h-full w-full shadow-lg shadow-gray-500/25" />
