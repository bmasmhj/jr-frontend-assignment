            ...
            <div className="px-4  grid grid-cols-6 gap-4 w-full container">
                {
                    res.map((dat , indx )=>{
                        ...
                        <img src={`https://e-cdns-images.dzcdn.net/images/artist/${dat.ART_PICTURE.md5}/242x242-000000-80-0-0.${dat.ART_PICTURE.format}`} alt="Ryan Tompson" className="inline-block relative object-cover object-center rounded-full h-50 w-50 shadow-lg shadow-gray-500/25" />
